...
This directory contains a copy of the **Lattice Estimator**, an open-source tool for estimating the security of lattice-based cryptographic schemes. This tool is used by the parent project (**Lore KEM**) for security analysis.
...
All credit for the code within this directory goes to its original authors. It is included here for convenience to reproduce the security analysis results for the Lore scheme.
